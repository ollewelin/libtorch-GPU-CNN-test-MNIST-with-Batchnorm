...
auto main() -> int {
 ...
 //   device_type = torch::kCPU;
  ...
  GPUtensor[0][2] = 15.4;
  cout << "CPUtensor" << CPUtensor << endl;
  cout << "GPUtensor" << GPUtensor << endl;
  torch::Tensor CPUtensor2 = GPUtensor.to(torch::kCPU);
  //CPUtensor2.copy_(GPUtensor);
  cout << "CPUtensor2" << CPUtensor2 << endl;
  cout << "GPUtensor" << GPUtensor << endl;
...
test_class = 0;
    ...
    printf("************************************* \n");
    printf("***** Test image One sample ********* \n");
    printf("************************************* \n");
  //    test(1, model, device, *test_loader, optimizer, test_dataset_size);

  //  test(1, model, device, *test_loader_one_samp, optimizer, test_dataset_one_samp_size);
